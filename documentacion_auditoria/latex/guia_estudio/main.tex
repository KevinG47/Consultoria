...
\begin{enumerate}[label=\textbf{P\arabic*.}]
  ...
  \item \textbf{Con solo dos transiciones entre las 3 convocatorias
        (781$\rightarrow$833$\rightarrow$894), ¿qué estiman con
        Kaplan--Meier/Cox?} \quien{Valentina} --- Modelamos la permanencia entre
        ondas consecutivas como supervivencia discreta/por intervalos; es un
        análisis acotado y exploratorio, y el contraste con Markov es
        metodológico (supuestos distintos), no una promesa de inferencia fina.
        (El ``2019'' que a veces se cita es la fecha de resolución de la
        833/2018, no una onda extra.)
\end{enumerate}
