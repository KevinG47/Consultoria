...
Este documento se centra en el criterio 2. Los demás criterios de la
rúbrica — Entendimiento del objetivo del repositorio; Documentación y crítica por archivo de código; Validación de la calidad estadística; Lógica de creación del repositorio y Línea de tiempo de commits — se desarrollan a fondo en sus propios documentos
