...
oficiales —con el cruce contra la producción de grupos ya ejecutado como
línea base de contexto—, y entregar un marco de indicadores y un tablero de
auditoría que orienten la mejora del observatorio de capital humano científico
en Colombia.}

El objetivo general responde exactamente al problema planteado: no es más
ancho (se limita al padrón, 2013--2021) ni más
angosto (abarca las tres dimensiones de la pregunta: fiabilidad,
comparabilidad y equidad). El cruce con la producción de grupos
(\texttt{33dq-ab5a}) se usó para cuantificar la cobertura del padrón
(36,9\,\% de autores reconocidos, §1.2) y queda documentado como
\textbf{contexto de línea base}: no es objeto de ningún objetivo específico,
que se centran en el padrón, de modo que su eventual indisponibilidad no
compromete el cumplimiento (plan B en §4.3).
