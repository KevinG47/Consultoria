...
\lstdefinestyle{auditoria}{
  ...
  % UTF-8 dentro de lstlisting (pdfLaTeX): mapeo literate de acentos/símbolos
  literate=
...
\newcommand{\doccommit}{no-disponible}
...
{\small \textbf{Commit auditado}: \texttt{\doccommit}}\\[0.3cm]
